...
class admin extends MY_Controller
{
    ...
    {
        $data = $this->kelas->getAllRuangKelas();
        echo json_encode($data);
    }

    public function getAllKelasEmpty()
    {
        $data = $this->kelas->getAllKelasEmpty();
        echo json_encode($data);
    }

    public function inputruangkelas()
    {
        $data = $this->kelas->addruangkelas();
        echo json_encode($data);
    }

    public function updateruangkelas()
    {
        $data = $this->kelas->updateruang();
        echo json_encode($data);
    }

    public function deleteruangkelas()
    {
        $data = $this->kelas->deleteruang();
        echo json_encode($data);
    }

    public function inputkelas()
    {
        $data = $this->kelas->addkelas();
        echo json_encode($data);
    }
    public function getkelaslist()
    {
        $data = $this->kelas->pilih();
        // var_dump($data);
        echo json_encode($data);
    }
    ...
    {
        $data = $this->kelas->postupdatekelas();
        echo json_encode($data);
    }

    public function deletekelas()
    {
        $data = $this->kelas->postdeletekelas();
        echo json_encode($data);
    }
